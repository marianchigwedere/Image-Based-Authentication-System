...
<!--===============================================================================================-->
	...
	<script>
		$('#login').click(function(e){
			e.preventDefault();
			let toPost= $('form').serialize();
			$.post('./php/login.php', toPost , function(data, resp){
			...
			.fail(function(error){
				$('#resp').html('Oops! something went wrong while trying transfer your request');
